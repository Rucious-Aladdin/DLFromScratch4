...
class Renderer:
    ...
    def render_v(self, v=None, policy=None, print_value=True, savefig=False, filename='image.png'):
        self.set_figure()
        ...
        if savefig:
            ...
            plt.savefig(os.path.join("./viz_images", filename))
        plt.show()
        

    def render_q(self, q, show_greedy_policy=True, savefig=False, filename='image.png'):
        self.set_figure()
